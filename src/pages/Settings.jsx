...
export default function Settings() {
  ...
  return (
    <div className="w-full flex flex-col gap-6 p-2 max-w-2xl">
      <h1 className="text-2xl font-heading font-bold text-theme-text-main pt-10 mb-2">Settings & Integrations</h1>

      <div className="bg-theme-bg-card border border-theme-border rounded-2xl p-6 shadow-sm relative overflow-hidden text-theme-text-main">
         <div className="absolute top-0 right-0 p-4 opacity-5 pointer-events-none text-theme-primary-btn"><Sparkles size={120} /></div>
         
         <h2 className="text-lg font-heading font-semibold text-theme-primary-btn mb-4 flex items-center gap-2">
             ...
             <div>
                 <label className="text-xs font-medium text-theme-text-muted">Secret API Key</label>
                   <input 
                      ...
                      placeholder="AIzaSy..."
                      className="w-full border border-theme-border rounded-xl p-3 text-sm outline-none focus:border-theme-primary-btn font-mono bg-theme-bg-main/5 shadow-inner mt-1 text-theme-text-main"
                  />
             ...
             <div>
                 <label className="text-xs font-medium text-theme-text-muted flex items-center gap-1"><Cpu size={14}/> Target Model Selection</label>
                  <input 
                      ...
                      className="w-full border border-theme-border rounded-xl p-3 text-sm outline-none focus:border-theme-primary-btn font-mono bg-theme-bg-main/5 mt-1 text-theme-text-main"
                  />
